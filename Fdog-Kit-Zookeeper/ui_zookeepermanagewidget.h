...
public:
    ...
    void setupUi(QWidget *zookeepermanagewidget)
    {
        ...
        zookeepermanagewidget->resize(853, 506);
        zookeepermanagewidget->setStyleSheet(QLatin1String("#zookeepermanagewidget {\n"
...
"}"));
        ...
        horizontalLayout->setContentsMargins(0, 10, 10, 0);
...
"}"));
        ...
        widget_side_body->setStyleSheet(QStringLiteral("background-color: rgba(255, 255, 255, 0);"));
...
"}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 180, 416));
        scrollAreaWidgetContents->setStyleSheet(QString::fromUtf8("QToolButton {\n"
...
"}"));
        ...
        widget_right->setStyleSheet(QStringLiteral(""));
...
"}"));
        ...
        horizontalWidget->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
